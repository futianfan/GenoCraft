...
class DDN:
    ...
    def DDNPipline(self, casedata, controldata, gene_name_file, output_file='', lambda1=lambda1, lambda2=lambda2):
        # import case data
...
if __name__ == "__main__":
    ddn = DDN()
    neighbors = ddn.DDNPipline(case_data='case_label.txt', \
                               control_data='control_label.txt', \
                               gene_name_file='genename.txt', \
                               output_file='differential_network.csv', \
                               lambda1=lambda1, lambda2=lambda2)
    # neighbors = ddn.DDNPipline(case_data_file='case_label.txt', \
    #                            control_data_file='control_label.txt', \
    #                            gene_name_file='genename.txt', \
    #                            output_file='differential_network.csv', \
    #                            lambda1=lambda1, lambda2=lambda2)
